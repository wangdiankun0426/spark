          ...
          <div class="card-content">
            ...
            <div class="card-title">
              ...
              <div class="card-actions">
                <el-button text type="primary" @click="handleOpenGraphDetail(document)">
 ...
 * 打开文档分块页（新开标签页）
 */
function handleOpenChunkPage(row) {
 ...
 * @param row
 */
const handleOpenGraphDetail = (row) => {
  const {href} = router.resolve({path: '/graph/detail', query: {docId: row.id}});
  window.open(href, '_blank');
}
