...
import {pageNoticeListAPI,createNoticeAPI, updateNoticeAPI, noticeDetailAPI, deleteNoticeAPI, delistNoticeAPI} from '@/api/manage/sys/notice.js';
...
function handleEditNotice(row) {
  window.open("/manage/sys/notice/edit/"+row.id);
}
