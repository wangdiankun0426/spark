<template>
  <div>
    <el-container>
      <el-aside width="160px" class="admin-el-aside">
        <el-menu
          ...
          <el-sub-menu index="1">
            <template #title>
              ...
              <span style="color: #ffffff">系统数据</span>
            </template>
          ...
          <el-sub-menu index="2">
            <template #title>
              <el-icon><Ai /></el-icon>
              <span style="color: #ffffff">AI管理</span>
            </template>
          ...
          <el-sub-menu index="3">
            <template #title>
              ...
              <span style="color: #ffffff">知识库管理</span>
            </template>
          ...
          <el-sub-menu index="4">
            <template #title>
              ...
              <span style="color: #ffffff">知识图谱管理</span>
            </template>
          ...
          <el-sub-menu index="6">
            <template #title>
              ...
              <span style="color: #ffffff">表单管理</span>
            </template>
