<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column prop="userNames" label="接收人" width="220" align="center">
        <template #default="scope">
          <el-tooltip :content="formatUserNames(scope.row)" placement="bottom" effect="dark">
            <span>{{ formatUserNames(scope.row) }}</span>
          </el-tooltip>
        </template>
      </el-table-column>
  ...
  >
    <el-descriptions :column="1" border>
      ...
      <el-descriptions-item label="接收人">{{ formatUserNames(messageDetail) }}</el-descriptions-item>
...
import {pageMessageListAPI, sendMessageAPI, deleteMessageAPI} from '@/api/system/message';
