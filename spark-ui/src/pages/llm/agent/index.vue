  ...
  <div class="app-container">
    ...
    >
      ...
      >
        <!-- 状态徽章 -->
        <template #badge>
          <span class="badge" :class="agent.status === 1 ? 'badge-primary' : 'badge-muted'">
            {{ agent.statusName}}
          </span>
        </template>
        <!-- 标签区：语言模型 / 记忆 / 工具 / 知识库 / MCP / 技能 -->
        <template #tags>
          <el-tag size="small" effect="light" round>记忆 {{ agent.maxMessages }} 轮</el-tag>
