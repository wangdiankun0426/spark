...
<script setup>
import {ref} from 'vue';
import widgetPanel from './widgetPanel/index';
import formWidget from './formWidget/index';
import settingPanel from './settingPanel/index';
import FormView from '../FormView/index';
import {queryFormJsonAPI, saveFormJsonAPI} from '@/api/form/form';
